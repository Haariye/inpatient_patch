...
FIELD_CONFIGS = [
    ...
    {"dt": "Inpatient Record", "fieldname": "custom_chief_complaint",
     "fieldtype": "Small Text", "label": "Chief Complaint",
     "insert_after": "custom_admitting_doctor"},
    {"dt": "Inpatient Record", "fieldname": "custom_primary_diagnosis",
     "fieldtype": "Data", "label": "Primary Diagnosis",
     "insert_after": "custom_chief_complaint"},
    ...
    {"dt": "Inpatient Record", "fieldname": "custom_allow_outstanding_discharge",
     "fieldtype": "Check", "label": "Allow Discharge With Outstanding",
     "description": "Tick to allow discharge even if the bill is not fully paid (e.g. sponsored patient).",
     "insert_after": "custom_is_sponsored"},
